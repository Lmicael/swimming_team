...
void main() {
  runApp(AthleteRegistrationScreen_Athlete());
}

class AthleteRegistrationScreen_Athlete extends StatefulWidget {
  @override
...
class _AthleteRegistrationScreenState
    extends State<AthleteRegistrationScreen_Athlete> {
